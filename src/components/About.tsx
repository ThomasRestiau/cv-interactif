        ...
        <FadeIn>
            <section id="about"
                ...
                <p className="text-xl font-semibold mb-4 max-w-2xl">
                    ...
                    sciences humaines et développement logiciel.
                </p>
                ...
                <p className="max-w-2xl leading-relaxed mt-4">
                    ...
                    présentant des troubles du développement ou des difficultés psychiques. Cet accompagnement, inscrit dans le
                    quotidien et dans des ateliers spécifiques, m’a appris à poser un cadre, à observer des logiques
                    sous-jacentes, à tenir compte de la singularité de chaque situation, et à élaborer avec rigueur
                    des interventions cliniques précises, ajustées et pertinentes.
                </p>

                <p className="max-w-2xl leading-relaxed mt-4">
                    Aujourd’hui, je transpose ces qualités dans le développement. Face à un système ou à un problème
                    technique, j’aborde les choses avec méthode, patience et exigence. J’aime comprendre le fonctionnement
                    en profondeur, structurer des solutions claires, et créer des applications robustes et cohérentes, pensées pour
                    durer et pour répondre à des besoins réels.
                </p>

                <p className="max-w-2xl leading-relaxed mt-4">
                    Formé à Technifutur® (Java/Angular), et poursuivant un bachelier en informatique (cours du soir),
                    j’ai commencé à développer des projets en Java, Spring Boot, Angular, PostgreSQL, Docker…
                    Plusieurs sont encore en cours, mais chacun reflète ma volonté de progresser, de structurer,
                    et de coder avec clarté.
                </p>

                <p className="max-w-2xl leading-relaxed mt-4">
                    Ce que j’aime, c’est structurer, clarifier, rendre intelligible. J’accorde beaucoup d’importance à
                    la lisibilité du code, à l’architecture logique, et à la progression continue — technique comme
                    humaine.
                </p>
