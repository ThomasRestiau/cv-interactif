        ...
        <FadeIn>
            <section id="whyme"
                ...
                <p className="text-lg leading-relaxed">
                    ...
                    recopiant des tutos,
                    mais en menant des projets concrets, avec l’exigence d’un adulte déjà confronté à la complexité du
                    terrain.
                </p>
                <p className="text-lg leading-relaxed mt-4">
                    ...
                    d’un
                    outil.
                    Quand je commence quelque chose, je vais jusqu’au bout. Je structure, je documente, je progresse
                    vite,
